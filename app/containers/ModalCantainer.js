  ...
  render() {
    ...
    return (
      <View style={styles.wrapper}>
        {/*<Button onPress={() => this.refs.modal1.open()} style={styles.btn} title={'Basic modal'}></Button>*/}
        {/*<Button onPress={() => this.refs.modal2.open()} style={styles.btn} title={'Position top'}></Button>*/}
        {/*<Button onPress={() => this.refs.modal3.open()} style={styles.btn} title={'Position centered + backdrop + disable'}></Button>*/}
        {/*<Button onPress={() => this.refs.modal4.open()} style={styles.btn} title={'Position bottom + backdrop + slider'}></Button>*/}
        {/*<Button onPress={() => this.setState({isOpen: true})} style={styles.btn} title={'Backdrop + backdropContent'}></Button>*/}
        {/*<Button onPress={() => this.refs.modal6.open()} style={styles.btn} title={'Position bottom + ScrollView'}></Button>*/}
        {/*<Button onPress={() => this.refs.modal7.open()} style={styles.btn} title={'Modal with keyboard support'}></Button>*/}
