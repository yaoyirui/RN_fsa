...
class RefreshAuthorization extends Component {
  ...
  onPressToRefresh = () => {
    runAfterInteractionsBasic(() => {
      this.props.dispatch(createAction('pms/refreshAuthorization')({subscriberId: this.props.chooseSubscriber.subscriberId}));
    })
  }
      ...
      if (chooseSubscriber) {
        return <View style={{flex: 1}}>
          <View style={styles.viewFour}>
            <Text style={styles.textInViewFour}>选择刷新授权的用户</Text>
          </View>
          ...
          <View>
            <TouchableOpacity onPress={this.onPressToRefresh}>
              <View style={styles.viewButtonConfirm}>
                <Text style={styles.textConfirmStyle}>刷新授权</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.viewTop}>
          ...
          <Text style={styles.topTextStyle}>{'刷新授权'}</Text>
        ...
        <ModalOperationSuccess successTitleText='授权' successText='该用户授权成功' goBack={this.goBack}/>
        <ModalOperationFail failTitleText='授权'/>
      </View>
    )
  }
