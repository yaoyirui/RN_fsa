...
class ModalValidateSubscribers extends PureComponent {

  onChooseSubscriber = (subscriber) => {
    runAfterInteractionsWithToast(() => {
      this.props.dispatch(createAction('pms/chooseSubscriber')({chooseSubscriber: subscriber}))
    })
  }

  closeChooseSubscriberModal = () => {
    this.props.dispatch(createAction('pms/showOrCloseChooseSubscriberModal')({showChooseSubscriberModal: false}))
  }
  ...
  render() {
    ...
    const {subscribers, showChooseSubscriberModal} = this.props;


    return (
      <Modal style={styles.modal}
             visible={showChooseSubscriberModal}
             transparent={true}
             maskClosable={true}
...
export default ModalValidateSubscribers
