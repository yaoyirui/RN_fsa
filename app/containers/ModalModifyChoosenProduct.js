...
class ModalModifyChoosenProduct extends Component {
  ...
  closeModifyChooseProductModal = () => {
    this.props.dispatch(createAction('product/closeModifyChooseProductModal')())
  }
...
export default ModalModifyChoosenProduct
