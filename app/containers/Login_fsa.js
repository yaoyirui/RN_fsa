...
class LoginFSA extends Component {
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.textInputViewStyle, styles.textInputViewStyleCode]}>
          ...
          <TextInput
            ...
            multiline={true}
            //inlineImageLeft = "login_ic"
            placeholder='编号'
            underlineColorAndroid="transparent"
            defaultValue={this.state.operCode}
            onChangeText={(text) => this.setState({'code': text})}
            onEndEditing={this.onCodeEndEdit}
          />

          <View style={styles.view_icon_style}>
            <TouchableOpacity onPress={this.onPressClean}>
              <Image
                style={styles.ic_icon}
