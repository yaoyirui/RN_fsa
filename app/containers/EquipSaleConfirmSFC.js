...
const renderChooseProducts = (products, calculate, params) => {
  ...
  return <View style={{flex: 1, backgroundColor: 'white'}}>
    <View style={styles.viewFour}>
      <Text style={styles.textInViewFour}>{'订购的周边资源列表'}</Text>
    </View>
          ...
          if (pricePlan.choosen) {
            ...
            return <View key={index} style={[styles.viewSix]}>
              <View style={styles.viewSixInner}>
                ...
                <Text
                  style={styles.textInViewSixInner}>{'订购数量:' + product.orderNum + '  订购费用:￥' + productAmount}</Text>
              </View>
            </View>
          }
        }) : <View/>
...
function EquipSaleConfirmSFC({chooseCustomer, chooseProducts, calculate, params}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <TouchableOpacity onPress={params.onPressToOrder}>
...
export default EquipSaleConfirmSFC;
